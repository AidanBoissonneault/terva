...
<template>
	<div class="legal-doc">
		...
		<p>
			We are <strong>Aidan Boissonneault</strong>, doing business as <strong>Terva</strong>
			("Company", "we", "us", or "our"), a company registered in Canada, located in North Bay, Ontario.
		</p>
		<p>
			We operate the website <a href="https://www.tervabrewed.com" target="_blank"
				rel="noopener">https://www.tervabrewed.com</a> (the "Site"),
			the mobile application <strong>Terva</strong> (the "App"), as well as any other related products and services
		...
		<p>
			...
			or by mail to North Bay, Ontario, Canada.
		</p>
		<p>
			These Legal Terms constitute a legally binding agreement between you and Aidan Boissonneault
			concerning your access to and use of the Services. By accessing the Services, you confirm that you have
		...
		<p>
			...
			Modified Legal Terms become effective upon posting or notifying you by
			<a href="mailto:noreply@tervabrewed.com">noreply@tervabrewed.com</a>.
			By continuing to use the Services after any changes take effect, you agree to be bound by the modified terms.
		</p>
		<p>
		...
		<nav class="toc">
			...
			<a href="#license">10. Contribution Licence</a>
			<a href="#mobile">11. Mobile Application Licence</a>
			<a href="#socialmedia">12. Social Media</a>
			<a href="#sitemanage">13. Services Management</a>
			<a href="#privacy">14. Privacy Policy</a>
			<a href="#copyright">15. Copyright Infringements</a>
			<a href="#termination">16. Term and Termination</a>
			...
			<a href="#electronic">25. Electronic Communications, Transactions, and Signatures</a>
			<a href="#california">26. California Users and Residents</a>
			<a href="#misc">27. Miscellaneous</a>
			<a href="#contact">28. Contact Us</a>
		</nav>
		...
		<p>
			...
			or which would subject us to any registration requirement within such jurisdiction or country. Those who access
			the Services from other locations do so on their own initiative and are solely responsible for compliance with
			local laws.
		</p>
		<p>
			The Services are not tailored to comply with industry-specific regulations (HIPAA, FISMA, etc.).
		...
		<p>
			...
			<a href="#prohibited">Prohibited Activities</a> section below, we grant you a non-exclusive,
		...
		<p>
			...
			distributed, sold, licensed, or otherwise exploited for any commercial purpose without our express
			prior written permission.
		</p>
		<p>
			For licensing requests, contact: <a href="mailto:tervabrewed@gmail.com">tervabrewed@gmail.com</a>.
			Any permitted use must identify us as the owners or licensors and include any required copyright notices.
		</p>
		...
		<p>
			...
			or other information about the Services ("Submissions"), you agree to assign to us all intellectual property
			rights in such Submission. We shall own this Submission and be entitled to its unrestricted use for any
			lawful purpose, without acknowledgment or compensation to you.
		</p>
		<p>
			<strong>Contributions:</strong> The Services may invite you to create, submit, post, or distribute content
			and materials ("Contributions"). Any Submission that is publicly posted shall also be treated as a Contribution.
			You understand that Contributions may be viewable by other users.
		</p>
		<p>
			<strong>When you post Contributions, you grant us a licence:</strong> By posting any Contributions,
			you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable,
			royalty-free, fully-paid, worldwide right and licence to use, copy, reproduce, distribute, sell,
			publish, broadcast, store, publicly display, reformat, translate, excerpt, and exploit your
			Contributions for any purpose, commercial or otherwise, and to prepare derivative works of, or
			incorporate them into other works.
		</p>
		<p>
			<strong>You are responsible for what you post or upload.</strong> By posting Contributions, you:
		</p>
		<ul>
			<li>Confirm you will not post content that is illegal, harassing, hateful, harmful, defamatory,
				obscene, abusive, discriminatory, threatening, sexually explicit, false, or misleading;</li>
			<li>Waive any moral rights to such Contributions to the extent permitted by law;</li>
			<li>Warrant that Contributions are original to you or that you have the necessary rights to submit them;</li>
			<li>Warrant that Contributions do not constitute confidential information.</li>
		</ul>
		<p>You are solely responsible for your Contributions and agree to reimburse us for any losses
			resulting from your breach of this section, any third party's intellectual property rights, or applicable law.</p>
		<p>
			<strong>We may remove or edit your Content</strong> at any time without notice if we reasonably consider
		...
		<p>
			...
			through the Services infringes upon any copyright you own or control, please refer to the
			<a href="#copyright">Copyright Infringements</a> section below.
		</p>

		<h2 id="userreps">3. USER REPRESENTATIONS</h2>
		<p>By using the Services, you represent and warrant that:</p>
		<ul>
			<li>All registration information you submit will be true, accurate, current, and complete, and you will
				maintain the accuracy of such information;</li>
			<li>You have the legal capacity and agree to comply with these Legal Terms;</li>
			<li>You are not a minor in the jurisdiction in which you reside;</li>
			<li>You will not access the Services through automated or non-human means, whether through a bot,
		...
		<p>
			...
			You further agree to promptly update account and payment information so that we can complete your
			transactions and contact you as needed. Sales tax will be added to the price of purchases as required.
			We may change prices at any time. All payments shall be in US dollars.
		</p>
		<p>
			You authorise us to charge your chosen payment provider for any amounts upon placing your order.
		...
		<p>
			...
			until such time as you cancel. The length of your billing cycle will depend on the type of subscription
			plan you choose when you subscribe to the Services.
		</p>

		<h3>Free Trial</h3>
		<p>
			We offer a 14-day free trial to new users who register with the Services. The account will not be
			charged and the subscription will be suspended until upgraded to a paid version at the end of the
			free trial.
		</p>
		...
		<p>
			...
			Services, please email us at <a href="mailto:tervabrewed@gmail.com">tervabrewed@gmail.com</a>.
		</p>
		...
		<p>
			...
			end user licence agreement ("EULA"), the terms of the EULA will govern your use of the software.
			If such software is not accompanied by a EULA, then we grant you a non-exclusive, revocable, personal,
			and non-transferable licence to use such software solely in connection with our services and in
			accordance with these Legal Terms. Any software and any related documentation is provided "AS IS"
			without warranty of any kind. You may not reproduce or redistribute any software except in accordance
		...
		<ul>
			<li>Systematically retrieve data or other content from the Services to create or compile a collection,
			...
			<li>Upload or transmit viruses, Trojan horses, or other material that interferes with any party's
				uninterrupted use and enjoyment of the Services.</li>
			...
			<li>Upload or transmit any material that acts as a passive or active information collection or
				transmission mechanism, including spyware or passive collection mechanisms.</li>
			...
			<li>Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML, JavaScript,
				or other code.</li>
			<li>Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer any
				of the software comprising or in any way making up a part of the Services.</li>
			<li>Except as may be the result of standard search engine or browser usage, use, launch, develop, or
				distribute any automated system, including any spider, robot, cheat utility, scraper, or offline reader
				that accesses the Services.</li>
			<li>Use a buying agent or purchasing agent to make purchases on the Services.</li>
			<li>Make any unauthorised use of the Services, including collecting usernames and/or email addresses
				of users for the purpose of sending unsolicited email, or creating user accounts by automated means
				or under false pretences.</li>
			<li>Use the Services as part of any effort to compete with us or otherwise use the Services and/or
				the Content for any revenue-generating endeavour or commercial enterprise.</li>
			<li>Scrape, copy, or redistribute other users' recipes or brew data without permission.</li>
		</ul>

		<h2 id="ugc">9. USER GENERATED CONTRIBUTIONS</h2>
		<p>
			The Services may invite you to create, submit, post, display, transmit, or distribute content and materials
			("Contributions"). Contributions may be viewable by other users of the Services and through third-party
			websites. Any Contributions you transmit may be treated as non-confidential and non-proprietary.
			When you create or make available any Contributions, you represent and warrant that:
		</p>
		<ul>
			<li>Your Contributions do not infringe the proprietary rights of any third party, including copyright,
				patent, trademark, trade secret, or moral rights.</li>
			<li>You are the creator and owner of, or have the necessary licences, rights, consents, releases, and
				permissions to use and to authorise us and other users to use your Contributions.</li>
			...
			<li>Your Contributions are not unsolicited or unauthorised advertising, promotional materials, pyramid
				schemes, chain letters, spam, or other forms of solicitation.</li>
			<li>Your Contributions are not obscene, lewd, violent, harassing, libellous, slanderous, or otherwise
				objectionable.</li>
			...
			<li>Your Contributions do not violate any applicable law concerning child pornography or the
				protection of minors.</li>
			<li>Your Contributions do not include offensive comments connected to race, national origin, gender,
		...
		<p>
			...
			and licence to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive,
			store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt, and distribute
			such Contributions for any purpose, commercial, advertising, or otherwise, and to prepare derivative works
			of, or incorporate into other works, such Contributions.
		</p>
		<p>
			This licence will apply to any form, media, or technology now known or hereafter developed. You waive
			all moral rights in your Contributions, and you warrant that moral rights have not otherwise been asserted
		...
		<p>
			...
			you in any area on the Services.
		</p>
		<p>
			We have the right, in our sole and absolute discretion, to (1) edit, redact, or otherwise change any
			Contributions; (2) re-categorise any Contributions to place them in more appropriate locations on the
			Services; and (3) pre-screen or delete any Contributions at any time and for any reason, without notice.
			We have no obligation to monitor your Contributions.
		</p>

		<h2 id="mobile">11. MOBILE APPLICATION LICENCE</h2>
		<h3>Use Licence</h3>
		<p>
			...
			strictly in accordance with the terms and conditions of this mobile application licence. You shall not:
			(1) except as permitted by applicable law, decompile, reverse engineer, disassemble, attempt to derive
			the source code of, or decrypt the App; (2) make any modification, adaptation, improvement, enhancement,
			...
			posted by us or the licensors of the App; (5) use the App for any revenue-generating endeavour or
			commercial enterprise; (6) make the App available over a network permitting access or use by multiple
			devices or users at the same time; (7) use the App for creating a product, service, or software that is
			directly or indirectly competitive with or a substitute for the App; (8) use the App to send automated
			queries to any website or to send any unsolicited commercial email; or (9) use any proprietary
			information or our intellectual property in the design, development, manufacture, licensing, or
		...
		<p>
			...
			(each an "App Distributor"): (1) the licence granted to you for our App is limited to a non-transferable
			licence to use the application on a device that utilises the Apple iOS or Android operating systems, as
			applicable, and in accordance with the applicable App Distributor's terms of service; (2) we are
			responsible for providing maintenance and support services with respect to the App; (3) in the event of
			any failure of the App to conform to any applicable warranty, you may notify the App Distributor, and the
			App Distributor may refund the purchase price, if any; (4) you represent and warrant that you are not
			located in a country subject to a US government embargo and are not listed on any US government list of
			prohibited or restricted parties; (5) you must comply with applicable third-party terms of agreement when
			using the App; and (6) you acknowledge that the App Distributors are third-party beneficiaries of the
			terms and conditions in this mobile application licence and will have the right to enforce them against
		...
		<p>
			...
			with third-party service providers ("Third-Party Accounts"). By granting us access to any Third-Party
			Accounts, you understand that we may access, make available, and store any content that you have provided
			to and stored in your Third-Party Account so that it is available on and through the Services via your
			account. You will have the ability to disable the connection between your account on the Services and your
			Third-Party Accounts at any time.
		</p>
		<p>
			<strong>PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR
				THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS.</strong>
			We are not responsible for any Social Network Content. We will attempt to delete any information stored
			on our servers that was obtained through such Third-Party Accounts upon disconnection, except the username
		...
		<p>
			...
			these Legal Terms, including reporting such user to law enforcement authorities; (3) in our sole
			discretion and without limitation, refuse, restrict access to, limit the availability of, or disable any
			of your Contributions or any portion thereof; (4) remove from the Services or otherwise disable all files
		...
		<h2 id="privacy">14. PRIVACY POLICY</h2>
		<p>
			...
			States and expressly consent to have your data transferred to and processed in the United States.
		</p>

		<h2 id="copyright">15. COPYRIGHT INFRINGEMENTS</h2>
		<p>
			We respect the intellectual property rights of others. If you believe that any material available on or
			...
			pursuant to applicable law you may be held liable for damages if you make material misrepresentations
			in a Notification. If you are not sure that material infringes your copyright, you should consider first
		...
		<p>
			...
			a new account under your name, a fake or borrowed name, or the name of any third party. In addition to
		...
		<p>
			...
			or other problems or need to perform maintenance, resulting in interruptions, delays, or errors.
		...
		<p>
			These Legal Terms shall be governed by and defined following the laws of Canada. Aidan Boissonneault
			and yourself irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve
		...
		<p>
			...
			Terms (each a "Dispute"), the parties agree to first attempt to negotiate any Dispute informally for at
		...
		<p>
			...
			according to the Rules of this ICAC. The number of arbitrators shall be one (1). The seat of arbitration
			shall be Toronto, Canada. The language of the proceedings shall be English. The governing law of these
			Legal Terms shall be the substantive law of Canada.
		</p>
		...
		<p>
			...
			(b) there is no right or authority for any Dispute to be arbitrated on a class-action basis; and
		...
		<p>
			The parties agree that the following Disputes are not subject to the above provisions: (a) any Disputes
			...
			or unauthorised use; and (c) any claim for injunctive relief.
		</p>
		...
		<p>
			...
			NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT AND WE
			WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT
			AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE RESULTING FROM YOUR ACCESS TO AND USE OF THE
			SERVICES, (3) ANY UNAUTHORISED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY PERSONAL INFORMATION
		...
		<p>
			...
			and control of any matter for which you are required to indemnify us, and you agree to cooperate with
			our defence of such claims.
		</p>
		...
		<p>
			These Legal Terms and any policies or operating rules posted by us on the Services constitute the entire
			agreement and understanding between you and us. Our failure to exercise or enforce any right or provision
			of these Legal Terms shall not operate as a waiver of such right or provision. These Legal Terms operate
			to the fullest extent permissible by law. We may assign any or all of our rights and obligations to others
			at any time. We shall not be responsible or liable for any loss, damage, delay, or failure to act caused
			by any cause beyond our reasonable control. If any provision or part of a provision of these Legal Terms
			is determined to be unlawful, void, or unenforceable, that provision is deemed severable from these Legal
		...
		<div class="contact-block">
			<p><strong>Aidan Boissonneault</strong></p>
			<p>North Bay, Ontario</p>
			<p>Canada</p>
			<p><a href="mailto:tervabrewed@gmail.com">tervabrewed@gmail.com</a></p>
		</div>

		<p class="generated-by">
			This Terms of Service was created using <a href="https://termly.io/products/terms-and-conditions-generator/"
				target="_blank" rel="noopener">Termly's Terms and Conditions Generator</a>.
		</p>
