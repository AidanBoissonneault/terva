...
<template>
	<div class="legal-doc">
		...
		<p>
			...
			and "our") uses cookies and similar technologies to recognize you when you visit our website
			at
			<a href="https://www.tervabrewed.com" target="_blank" rel="noopener noreferrer"
				>https://www.tervabrewed.com</a
			>
		...
		<p>
			Cookies set by the website owner (in this case, Aidan Boissonneault) are called "first-party
		...
		<p>
			We use first-party cookies for technical reasons in order for our Website to operate. These
			are "essential" or "strictly necessary" cookies required to provide you with core services
			such as staying signed in across sessions.
		</p>

		<h2>How can I control cookies?</h2>
		<p>
			You have the right to decide whether to accept or reject cookies. You can exercise your cookie
			rights by setting your preferences in the Cookie Preference Center. Essential cookies cannot
		...
		<p>
			The specific types of first-party cookies served through our Website and the purposes they
			...
			<table>
				<tbody>
					<tr>
						...
						<td class="value">session_token</td>
					</tr>
					<tr>
						<td class="label">Purpose:</td>
						<td class="value">
							Stores the session token used to authenticate and maintain your login session.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="value">Better Auth (authentication)</td>
					</tr>
					<tr>
		...
		<div class="cookie-table">
			<table>
				<tbody>
					<tr>
						<td class="label">Name:</td>
						<td class="value">session_data</td>
					</tr>
					<tr>
						<td class="label">Purpose:</td>
						<td class="value">
							Stores cached session data to reduce server lookups and improve performance when
		...
		<div class="cookie-table">
			<table>
				<tbody>
					<tr>
						<td class="label">Name:</td>
						<td class="value">dont_remember</td>
					</tr>
					<tr>
						<td class="label">Purpose:</td>
						<td class="value">
							Stores a flag indicating that the user opted out of the "remember me" feature,
							ensuring their session is not persisted beyond the current browser session.
						</td>
					</tr>
					<tr>
						<td class="label">Provider:</td>
		...
		<p>
			...
			us to recognize when someone has visited our Website or opened an email including them. In
		...
		<p>
			We do not serve targeted advertising through our Website and do not use cookies for
		...
		<p class="generated-by">
			...
			<a href="https://termly.io/products/cookie-consent-manager/" target="_blank" rel="noopener"
